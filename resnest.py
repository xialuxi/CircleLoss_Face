...
class BasicBlock(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None, radix=1,cardinality=1, bottleneck_width=64, 
                 avd=False, avd_first=False, dilation=1, is_first=False, last_gamma=False):
        ...
        if radix >= 1:
            self.conv2 = SplAtConv2d(
                ...
                dilation=dilation, groups=cardinality, bias=False, radix=radix)
        else:
...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, radix=1, groups=1, bottleneck_width=64,
                 ...
                 final_drop=0.0, last_gamma=False):
        self.cardinality = groups
    ...
    def _make_layer(self, block, planes, blocks, stride=1, dilation=1, is_first=True):
        ...
        if dilation == 1 or dilation == 2:
            layers.append(block(self.inplanes, planes, stride, downsample=downsample,
                                ...
                                dilation=1, is_first=is_first,last_gamma=self.last_gamma))
        elif dilation == 4:
            layers.append(block(self.inplanes, planes, stride, downsample=downsample,
                                radix=self.radix, cardinality=self.cardinality,
                                bottleneck_width=self.bottleneck_width,
                                avd=self.avd, avd_first=self.avd_first,
                                dilation=2, is_first=is_first,last_gamma=self.last_gamma))
        else:
        ...
        for i in range(1, blocks):
            layers.append(block(self.inplanes, planes,
                                ...
                                bottleneck_width=self.bottleneck_width,
                                avd=self.avd, avd_first=self.avd_first,
                                dilation=dilation,last_gamma=self.last_gamma))
